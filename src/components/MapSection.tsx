    ...
    <section id="location" className="py-16 bg-card">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Visit our traditional barber hairdressing salon</p>
        </div>
          ...
          <div className="animate-scale-in">
            <Card className="overflow-hidden hover-lift">
              <CardContent className="p-0">
                <div className="relative h-80 bg-barber-sand/20">
                  <iframe
          ...
          <div className="animate-slide-in-left space-y-6">
            <Card className="hover-lift">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-barber-terracotta/10 p-3 rounded-lg">
                    <MapPin className="h-6 w-6 text-barber-terracotta" />
                  </div>
                  <div>
            ...
            <Card className="hover-lift">
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-barber-terracotta/10 p-3 rounded-lg">
                    <Clock className="h-6 w-6 text-barber-terracotta" />
                  </div>
                  <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-barber-terracotta hover:bg-barber-desert text-white flex-1"
              >
              ...
              <Button 
                ...
                className="border-barber-terracotta text-barber-terracotta hover:bg-barber-terracotta hover:text-white flex-1"
              >
